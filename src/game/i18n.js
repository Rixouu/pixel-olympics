...
const TRANSLATIONS = {
  en: {
    ...
    lobby: {
      ...
      roster: {
        title: 'Racers',
        hintHTML: 'Tap the <b>colour</b> to recolour - tap the <b>racer</b> to change',
        mobileHint: 'Use the numbered slots below to edit each racer on mobile',
      },
      scene: 'Scene',
      ...
      rules: {
        title: 'Rules',
        hint: 'Keep the basics out of the main setup flow, but close when someone needs them.',
        bodyHTML: 'Pick a racer, choose a colour, name them - then cheer them to the finish.<br><br><b>Winner</b> hands out sips equal to the number of players. Everyone else drinks their finishing place; <b>last place</b> gets one extra. <b>Slowpoke clause:</b> never led the race -> +1 sip of shame.',
      },
  ...
  fr: {
    ...
    lobby: {
      ...
      taglineHTML: "Composez vos coureurs, puis poussez-les jusqu'a l'arrivee.<br>Le premier gagne - tous les autres boivent.",
      ...
      roster: {
        title: 'Coureurs',
        hintHTML: 'Touchez la <b>couleur</b> pour changer la teinte - touchez le <b>coureur</b> pour changer de perso',
        mobileHint: 'Utilisez les emplacements numerotes ci-dessous pour modifier chaque coureur sur mobile',
      },
      scene: 'Scene',
      ...
      rules: {
        title: 'Regles',
        hint: "Gardez l'essentiel hors du flux principal, mais laissez les regles a portee de main si quelqu'un en a besoin.",
        bodyHTML: "Choisissez un coureur, une couleur, donnez-lui un nom - puis encouragez-le jusqu'a l'arrivee.<br><br><b>Le gagnant</b> distribue autant de gorgees qu'il y a de joueurs. Tous les autres boivent leur place d'arrivee ; la <b>derniere place</b> prend une gorgee en plus. <b>Clause de la tortue :</b> n'a jamais mene la course -> +1 gorgee de honte.",
      },
